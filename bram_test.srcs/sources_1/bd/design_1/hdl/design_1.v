...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLanguage=VERILOG,numBlks=9,numReposBlks=7,numNonXlnxBlks=1,numHierBlks=2,maxHierDepth=0,da_axi4_cnt=2,da_board_cnt=1,da_bram_cntlr_cnt=1,da_ps7_cnt=1}" *) 
module design_1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire en_counter_1;
  wire [31:0]freq_counter_0_addrb;
  wire freq_counter_0_data_transfer_status;
  wire [31:0]freq_counter_0_dinb;
  wire freq_counter_0_enb;
  wire freq_counter_0_rstb;
  wire [3:0]freq_counter_0_web;
  ...
  wire reset_counter_1;
  wire reset_rtl_1;
  wire [0:0]rst_processing_system7_0_100M_interconnect_aresetn;
  wire [0:0]rst_processing_system7_0_100M_peripheral_aresetn;

  assign clk_in1_1 = clk_in1;
  assign en_counter_1 = en_counter;
  assign lock_high = clk_wiz_0_locked;
  assign reset_counter_1 = reset_counter;
  assign reset_rtl_1 = reset_rtl;
  assign trans_status = freq_counter_0_data_transfer_status;
GND GND
       (.G(GND_1));
VCC VCC
       (.P(VCC_1));
...
design_1_blk_mem_gen_0_0 blk_mem_gen_0
       (.addra(axi_bram_ctrl_0_BRAM_PORTA_ADDR),
        .addrb(freq_counter_0_addrb),
        .clka(axi_bram_ctrl_0_BRAM_PORTA_CLK),
        .clkb(processing_system7_0_FCLK_CLK0),
        .dina(axi_bram_ctrl_0_BRAM_PORTA_DIN),
        .dinb(freq_counter_0_dinb),
        .douta(axi_bram_ctrl_0_BRAM_PORTA_DOUT),
        .ena(axi_bram_ctrl_0_BRAM_PORTA_EN),
        .enb(freq_counter_0_enb),
        .rsta(axi_bram_ctrl_0_BRAM_PORTA_RST),
        .rstb(freq_counter_0_rstb),
        .wea(axi_bram_ctrl_0_BRAM_PORTA_WE),
        .web(freq_counter_0_web));
design_1_clk_wiz_0_0 clk_wiz_0
       (.clk_in1(clk_in1_1),
        ...
        .reset(reset_rtl_1));
design_1_freq_counter_0_0 freq_counter_0
       (.addrb(freq_counter_0_addrb),
        .data_transfer_status(freq_counter_0_data_transfer_status),
        .dinb(freq_counter_0_dinb),
        .en_counter(en_counter_1),
        .enb(freq_counter_0_enb),
        .meas_clk1(clk_wiz_0_clk_out1),
        .meas_clk2(clk_wiz_0_clk_out2),
        .meas_clk3(clk_wiz_0_clk_out3),
        .meas_clk4(clk_wiz_0_clk_out4),
        .meas_clk5(clk_wiz_0_clk_out5),
        .meas_clk6(clk_wiz_0_clk_out6),
        .meas_clk7(clk_wiz_0_clk_out7),
        .meas_clk8(GND_1),
